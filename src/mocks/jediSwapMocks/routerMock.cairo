...
use arbstark::dexs::jediSwap::interfaces::IRouter::{IRouter};
    ...
    impl routerMock of IRouter<ContractState> {
        ...
        fn swap_exact_tokens_for_tokens(ref self: ContractState, amountIn: u256, amountOutMin: u256, path_len: u8, path: Array<ContractAddress>, to: ContractAddress, deadline: u64){
